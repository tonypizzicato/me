...
var timeline = (0, _jquery2.default)('.timeline__block');
var skills = (0, _jquery2.default)('.skills__item');
...
var processTimelineBlock = function processTimelineBlock(i, b) {
    b = (0, _jquery2.default)(b);
...
var processSkillBlock = function processSkillBlock(i, b) {
    b = (0, _jquery2.default)(b);
...
timeline.each(function (i, block) {
    var b = (0, _jquery2.default)(block);

    if (b.offset().top > $window.scrollTop() + (0, _jquery2.default)(window).height() * 0.75) {
        b.find('.timeline__image, .timeline__content').addClass(CLASSES['hidden']);
    }
});

skills.each(function (i, block) {
    var b = (0, _jquery2.default)(block);

    if (b.offset().top > $window.scrollTop() + (0, _jquery2.default)(window).height() * 0.8) {
        b.find('.skills__logo, .skills__desc').addClass(CLASSES['hidden']);
    }
});

},{"./parallax":3,"jquery":1}],3:[function(require,module,exports){
'use strict';
 ...
 * Cache
 */
var $content = (0, _jquery2.default)('.js-parallax .js-parallax-move');
var $opacity = (0, _jquery2.default)('.js-parallax .js-parallax-opacity');

var wHeight = (0, _jquery2.default)(window).height();

(0, _jquery2.default)(window).on('resize', function () {
    wHeight = (0, _jquery2.default)(window).height();
});
